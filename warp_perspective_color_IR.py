...
print(transform_mtx)
corrected_display_color_image = cv2.warpPerspective(display_color_image,
                                                    transform_mtx,
                                                    (512, 424))
corrected_color_image = cv2.warpPerspective(color_image,
                                            transform_mtx,
                                            (512, 424))
display_images_together = np.concatenate((corrected_display_color_image,
                                          display_IR_Image),
                                         axis=1)
